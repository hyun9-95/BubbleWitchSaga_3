...
public static class UniTaskUtils
{
    ...
    public static async UniTask Yield(PlayerLoopTiming playerLoopTiming, CancellationToken cancellationToken = default)
    {
        await UniTask.Yield(playerLoopTiming, cancellationToken).SuppressCancellationThrow();
    }
