...
public static class ExtensionUtils
{
    ...
    public static bool CheckSafeNull<T>(this T obj)
    {
        return obj == null || obj.Equals(null);
    }

    public static float GetDistance(this Transform source, Transform target)
    {
        if (source.CheckSafeNull() || target.CheckSafeNull())
            return 0;
    ...
    public static void DeactiveWithFadeOut(this SpriteRenderer renderer, float duration, GameObject gameObject, Action callback = null)
    {
    ...
    public static void FadeOut(this SpriteRenderer renderer, float duration, Action callback = null)
    {
        renderer.DOFade(0f, duration).SetEase(Ease.Linear).OnComplete(() =>
        {
            callback?.Invoke();
